                            ...
                            <table id="featured-datatable" class="table table-sorting table-striped table-hover datatable dataTable no-footer" role="grid" aria-describedby="featured-datatable_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="featured-datatable" rowspan="1" colspan="1" aria-label="">Status</th>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?= $user->status; ?></td>
                                        <td>
                                        <?= $this->Form->postLink(__('Resend Approval'), ['action' => 'recover', 'yes'], ['class' => 'btn btn-xs btn-info', 'data' => ['email' => $user->email]])   ?>
